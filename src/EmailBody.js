...
const SENDER_NAME = "Gabriela Leão";
const SENDER_POSITION = "Assistente Comercial";
const SENDER_EMAIL = "gabriela.leao@msladvocacia.com.br";
const SENDER_PHONE = "(31) 99840-6545";
const SENDER_PHONE_WHATSAPP = "5531998406545";
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="color-scheme: light only; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                <!--[if mso]><p style="margin: 0.1px; line-height: 14px"><![endif]-->
                                                <a href="https://www.msladvocacia.com.br/" target="_blank" style="color-scheme: light only; font-size: 12px; font-family: Arial, Helvetica, sans-serif; text-decoration: none;">
                                ...
                                <table class="ws-tpl-e-mail" cellpadding="0" cellspacing="0" style="line-height: 14px; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="color-scheme: light only; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                <!--[if mso]><p style="margin: 0.1px; line-height: 14px"><![endif]-->
                                                <a href="mailto:${SENDER_EMAIL}" target="_blank" style="color-scheme: light only; font-size: 12px; font-family: Arial, Helvetica, sans-serif; text-decoration: none;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="padding-right: 10px; text-align: center; padding-top: 0;">
                                                <a href="https://www.linkedin.com/company/msladv" target="_blank">
                                            ...
                                            <td align="left" style="padding-right: 10px; text-align: center; padding-top: 0;">
                                                <a href="https://www.instagram.com/msl_adv/" target="_blank">
                                            ...
                                            <td align="left" style="padding-right: 10px; text-align: center; padding-top: 0;">
                                                <a href="https://twitter.com/msl_adv" target="_blank">
